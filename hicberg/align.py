...
def hic_align(genome : str, index : str, fq_for : str, fq_rev : str, sensitivity : str = 'very_sensitive', max_alignment :  int = None, cpus : int = 1, output : str = None, verbonse : bool = False) -> None:
    """
