...
epilogs = {
    "general": "For more information about hicberg, please visit :https://github.com/sebgra/hicberg",
...
@click.option(
    ...
    show_default=True,
    metavar="<float>",
    help="Rate to use for sub-sampling restriction map.",
)
@click.option(
    "--distance",
    "-D",
    ...
    show_default=True,
    metavar="<int>",
    help="Maximum distance beyond which pairs are discarded in omics mode.",
)
@click.option(
    "--cpus",
    "-t",
    ...
    show_default=True,
    metavar="<int>",
    help="Threads to use for analysis.",
)
@click.option(
    "--kernel-size",
    "-K",
    ...
    show_default=True,
    metavar="<int>",
    help="Size of the gaussian kernel for contact density estimation.",
)
@click.option(
    "--deviation",
    "-d",
    ...
    show_default=True,
    metavar="<float>",
    help="Standard deviation for contact density estimation.",
)
@click.option(
    "--mode",
    "-m",
    ...
    show_default=True,
    metavar="<str>",
    help="Statistical model to use for ambiguous reads assignment.",
)
@click.option(
    "--max-alignment",
    "-k",
    ...
    default=None,
    metavar="<int>",
    help="Set the number of alignments to report in ambiguous reads case. Value of -1 reports all alignments.",
)
@click.option(
    "--sensitivity",
    "-s",
    required=False,
    type=click.Choice(["very-sensitive", "sensitive", "fast", "very-fast"]),
    default="very-sensitive",
    show_default=True,
    metavar="<str>",
    help="Set sensitivity level for Bowtie2.",
)
@click.option(
    "--bins",
    "-b",
...
@click.option(
    ...
    show_default=True,
    metavar="<str>",
    help="Enzymes to use for genome digestion.",
)
@click.option(
    "--circular",
    "-c",
    ...
    show_default=True,
    metavar="<str>",
    help="Name of the chromosome to consider as circular.",
)
@click.option(
    "--mapq",
    "-q",
    ...
    show_default=True,
    metavar="<int>",
    help="Minimum mapping quality to consider a read as valid.",
)
@click.option(
    "--output",
    "-o",
...
@click.option(
    "--start-stage",
    required=False,
    type=click.Choice(["fastq", "bam", "groups", "build", "stats", "rescue", "final"]),
    default="fastq",
    show_default=True,
    metavar="<str>",
    help="Stage to start the pipeline.",
)
@click.option(
    "--exit-stage",
    required=False,
    type=click.Choice(["None", "bam", "groups", "build", "stats", "rescue", "final"]),
    default="None",
    show_default=True,
    metavar="<str>",
    help="Stage to exit the pipeline.",
)
@click.option(
    "--force",
    "-f",
    is_flag=True,
    show_default=True,
    help="Set if previous analysis files are deleted.",
)
@click.option(
    "--blacklist",
    "-B",
...
@click.option(
    ...
    show_default=True,
    metavar="<str>",
    help="Output folder to save results. If not set, the current directory is used.",
)
@click.option(
    "--name",
    "-n",
    ...
    show_default=True,
    metavar="<str>",
    help="Name of the output folder to create. If not set, 'sample' is used.",
)
@click.option(
    "--force", "-f", is_flag=True, help="Set if previous analysis files are deleted."
)
...
@click.option(
    ...
    show_default=True,
    metavar="<str>",
    help="Index of the genome (path). If not set, the index is built.",
)
@click.option(
    "--output",
    "-o",
...
@click.option(
    ...
    show_default=True,
    metavar="<int>",
    help="Set the number of alignments to report in ambiguous reads case. If set to -1, all alignments are reported.",
)
@click.option(
    "--cpus",
    "-t",
...
@click.option(
    ...
    type=int,
    default=35,
    help="Minimum mapping quality to consider a read as non ambiguous.",
)
@click.option(
    "--output",
    "-o",
...
@click.option(
    ...
    default=False,
    is_flag=True,
    help="Set if pairs are built after reads reassignment. Therefore alignment files of group2 will be used.",
)
...
@click.option(
    ...
    default=False,
    is_flag=True,
    help="Set if .cool matrix are built after reads reassignment. Therefor pairs file from group2 will be used.",
)
@click.option(
    "--cpus",
    "-t",
    ...
    default=1,
    type=int,
    help="Threads to use for matrix building.",
)
...
def statistics_cmd(
    ...
    p1 = Process(
        target=hst.get_patterns(
            circular=circular, blacklist=blacklist, output_dir=output
        )
    )
    p2 = Process(target=hst.generate_trans_ps(output_dir=output))
    p3 = Process(
        target=hst.generate_coverages(genome=data[0], bins=bins, output_dir=output)
    )
...
@click.option(
    ...
    show_default=True,
    metavar="<str>",
    help="Output folder to save the chunks.",
)
def chunk_cmd(data, chunks, output):
    ...
    """
    hut.chunk_bam(
        forward_bam_file=data[0],
        reverse_bam_file=data[1],
        nb_chunks=chunks,
        output_dir=output,
    )
...
@click.option(
    ...
    show_default=True,
    metavar="<str>",
    help="Chromosome to get as source for duplication.",
)
@click.option(
    "--position",
    "-p",
    ...
    show_default=True,
    metavar="<int>",
    help="Position to get as source for duplication.",
)
@click.option(
    "--trans-chromosome",
    "-C",
    ...
    show_default=True,
    metavar="<str>",
    help="Chromosome to get as target for duplication.",
)
@click.option(
    "--trans-position",
    "-P",
    ...
    show_default=True,
    metavar="<int>",
    help="Position to get as target for duplication.",
)
@click.option(
    "--bins",
    "-b",
    ...
    show_default=True,
    metavar="<int>",
    help="Number of bins to select from a genomic coordinates.",
)
@click.option(
    "--strides",
    "-s",
    ...
    show_default=True,
    metavar="<int>",
    help="Strides to apply from source genomic coordinates to define targets intervals. Multiple strides must be coma separated.",
)
@click.option(
    "--auto",
    "-a",
    ...
    show_default=True,
    metavar="<int>",
    help="Automatically select auto intervals for duplication.",
)
@click.option(
    "--kernel-size",
    "-K",
...
@click.option(
    ...
    show_default=True,
    metavar="<str>",
    help="Statistical model to use for ambiguous reads assignment. Multiple modes must be coma separated.",
)
@click.option(
    "--pattern",
    "-S",
    required=False,
    type=click.Choice(["loops", "borders", "hairpins", "-1"]),
    default=None,
    show_default=True,
    metavar="<str>",
    help="Set pattern if benchmarking considering patterns.",
)
@click.option(
    "--threshold",
    "-t",
    ...
    show_default=True,
    metavar="<float>",
    help="Set pattern score threshold under which pattern are discarded.",
)
@click.option(
    "--jitter",
    "-j",
    ...
    show_default=True,
    metavar="<int>",
    help="Set jitter for pattern detection interval overlapping",
)
@click.option(
    "--trend",
    "-T",
    is_flag=False,
    help="Set if detrending of the contact map has to be performed.",
)
@click.option(
    "--top",
    "-k",
    ...
    show_default=True,
    metavar="<int>",
    help="Set the top k % of patterns to retain.",
)
@click.option(
    "--iterations",
    "-i",
    ...
    show_default=True,
    metavar="<int>",
    help="Set the number of iterations for benchmarking.",
)
@click.option(
    "--force",
    "-f",
    is_flag=True,
    help="Set if previous analysis files have to be deleted.",
)
@click.option(
    "--cpus",
    required=False,
...
def benchmark_cmd(
    ...
    hbk.benchmark(
        ...
        position=position,
        trans_chromosome=trans_chromosome,
...
# This is only for local execution testing, it won't be used by setuptools
